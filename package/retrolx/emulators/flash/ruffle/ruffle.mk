...
RUFFLE_VERSION = 8cb5cf0252c6b23c01f8dbeafcb0d10b0de7eb48
...
define RUFFLE_INSTALL_TARGET_CMDS
	...
	# evmap config
	mkdir -p $(TARGET_DIR)/usr/share/evmapy
	cp $(BR2_EXTERNAL_RETROLX_PATH)/package/retrolx/emulators/ruffle/flash.ruffle.keys $(TARGET_DIR)/usr/share/evmapy
endef
