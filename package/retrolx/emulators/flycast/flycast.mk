...
ifeq ($(BR2_PACKAGE_RETROLX_TARGET_EXYNOS5422),y)
	...
	FLYCAST_EXTRA_ARGS += USE_GLES=1 USE_SDL=1 USE_SDLAUDIO=1
endif

ifeq ($(BR2_PACKAGE_RETROLX_TARGET_ARM64_A53_GLES2),y)
	FLYCAST_PLATFORM = odroidc2
	FLYCAST_EXTRA_ARGS += USE_SDLAUDIO=1
endif

ifeq ($(BR2_PACKAGE_RETROLX_TARGET_ARM64_A55_GLES3),y)
...
ifeq ($(BR2_PACKAGE_RETROLX_TARGET_ARM64_A53_GLES3),y)
	FLYCAST_PLATFORM = arm64
	FLYCAST_EXTRA_ARGS += USE_GLES=1
	FLYCAST_EXTRA_ARGS += USE_SDL=1 USE_SDLAUDIO=1
endif
