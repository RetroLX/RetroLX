...
class SimCoupeGenerator(Generator):
	...
	# Start emulator fullscreen
        commandArray = ["simcoupe", "--fullscreen"]
	...
	# falcon should use tos 4.XX
        ...
        tos = SimCoupeGenerator.findBestTos(biosdir, machine, tosversion, toslang)
	...
	# Floppy (B) options
        ...
        # config file
        SimCoupeGenerator.generateConfig(system, playersControllers)
