...
LIBRETRO_SNES9X2005_PKG_INSTALL_DIR = /userdata/packages/$(BATOCERA_SYSTEM_ARCH)/lr-snes9x2005
...
define LIBRETRO_SNES9X2005_MAKEPKG
	...
	cd $(LIBRETRO_SNES9X2005_PKG_DIR) && $(BR2_EXTERNAL_BATOCERA_PATH)/scripts/retrolx-makepkg \
	$(BR2_EXTERNAL_BATOCERA_PATH)/package/retrolx/emulators/libretro/libretro-snes9x2005/PKGINFO \
