...
LIBRETRO_VIRTUALJAGUAR_PKG_INSTALL_DIR = /userdata/packages/$(BATOCERA_SYSTEM_ARCH)/lr-virtualjaguar
...
define LIBRETRO_VIRTUALJAGUAR_MAKEPKG
	...
	cd $(LIBRETRO_VIRTUALJAGUAR_PKG_DIR) && $(BR2_EXTERNAL_BATOCERA_PATH)/scripts/retrolx-makepkg \
	$(BR2_EXTERNAL_BATOCERA_PATH)/package/retrolx/emulators/libretro/libretro-virtualjaguar/PKGINFO \
