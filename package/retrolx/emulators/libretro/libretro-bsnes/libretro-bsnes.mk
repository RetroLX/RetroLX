...
LIBRETRO_BSNES_PKG_INSTALL_DIR = /userdata/packages/$(BATOCERA_SYSTEM_ARCH)/lr-bsnes
...
define LIBRETRO_BSNES_MAKEPKG
	...
	cd $(LIBRETRO_BSNES_PKG_DIR) && $(BR2_EXTERNAL_BATOCERA_PATH)/scripts/retrolx-makepkg \
