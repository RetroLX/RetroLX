...
LIBRETRO_MAME2010_PKG_INSTALL_DIR = /userdata/packages/$(RETROLX_SYSTEM_ARCH)/lr-mame2010
...
define LIBRETRO_MAME2010_MAKEPKG
	...
	cd $(LIBRETRO_MAME2010_PKG_DIR) && $(BR2_EXTERNAL_RETROLX_PATH)/scripts/retrolx-makepkg \
	$(BR2_EXTERNAL_RETROLX_PATH)/package/retrolx/emulators/libretro/libretro-mame2010/PKGINFO \
