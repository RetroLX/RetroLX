...
LIBRETRO_FBNEO_VERSION = dab81ceeb50f8c5a45f869e15faf5b21f1068add
LIBRETRO_FBNEO_SITE = $(call github,libretro,FBNeo,$(LIBRETRO_FBNEO_VERSION))
LIBRETRO_FBNEO_LICENSE = Non-commercial

LIBRETRO_FBNEO_PKG_DIR = $(TARGET_DIR)/opt/retrolx/libretro
LIBRETRO_FBNEO_PKG_INSTALL_DIR = /userdata/packages/$(BATOCERA_SYSTEM_ARCH)/lr-fbneo
...
define LIBRETRO_FBNEO_MAKEPKG
	...
	cd $(LIBRETRO_FBNEO_PKG_DIR) && $(BR2_EXTERNAL_BATOCERA_PATH)/scripts/retrolx-makepkg \
	$(BR2_EXTERNAL_BATOCERA_PATH)/package/retrolx/emulators/libretro/libretro-fbneo/PKGINFO \
