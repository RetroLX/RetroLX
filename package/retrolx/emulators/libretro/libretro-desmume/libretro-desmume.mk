...
LIBRETRO_DESMUME_PKG_INSTALL_DIR = /userdata/packages/$(BATOCERA_SYSTEM_ARCH)/lr-desmume
...
define LIBRETRO_DESMUME_MAKEPKG
	...
	cd $(LIBRETRO_DESMUME_PKG_DIR) && $(BR2_EXTERNAL_BATOCERA_PATH)/scripts/retrolx-makepkg \
	$(BR2_EXTERNAL_BATOCERA_PATH)/package/retrolx/emulators/libretro/libretro-desmume/PKGINFO \
