...
LIBRETRO_ECWOLF_PKG_INSTALL_DIR = /userdata/packages/$(BATOCERA_SYSTEM_ARCH)/lr-ecwolf
...
define LIBRETRO_ECWOLF_MAKEPKG
	...
	cd $(LIBRETRO_ECWOLF_PKG_DIR) && $(BR2_EXTERNAL_BATOCERA_PATH)/scripts/retrolx-makepkg \
	$(BR2_EXTERNAL_BATOCERA_PATH)/package/retrolx/emulators/libretro/libretro-ecwolf/PKGINFO \
