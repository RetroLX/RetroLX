...
LIBRETRO_MUPEN64PLUS_NEXT_PKG_INSTALL_DIR = /userdata/packages/$(BATOCERA_SYSTEM_ARCH)/lr-mupen64plus-next
...
define LIBRETRO_MUPEN64PLUS_NEXT_MAKEPKG
	...
	cd $(LIBRETRO_MUPEN64PLUS_NEXT_PKG_DIR) && $(BR2_EXTERNAL_BATOCERA_PATH)/scripts/retrolx-makepkg \
	$(BR2_EXTERNAL_BATOCERA_PATH)/package/retrolx/emulators/libretro/libretro-mupen64plus-next/PKGINFO \
