...
LIBRETRO_FBALPHA2012_NEOGEO_VERSION = dc973ec25c6929e3ac47a0aac54fcde75b4b9bd4
...
define LIBRETRO_FBALPHA2012_NEOGEO_MAKEPKG
	...
	# Copy package files
	$(INSTALL) -D $(@D)/fbalpha2012_neogeo_libretro.so $(LIBRETRO_FBALPHA2012_NEOGEO_PKG_DIR)$(LIBRETRO_FBALPHA2012_NEOGEO_PKG_INSTALL_DIR)
