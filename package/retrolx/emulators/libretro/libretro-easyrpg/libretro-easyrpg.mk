...
LIBRETRO_EASYRPG_PKG_INSTALL_DIR = /userdata/packages/$(RETROLX_SYSTEM_ARCH)/lr-easyrpg
...
define LIBRETRO_EASYRPG_MAKEPKG
	...
	cd $(LIBRETRO_EASYRPG_PKG_DIR) && $(BR2_EXTERNAL_RETROLX_PATH)/scripts/retrolx-makepkg \
	$(BR2_EXTERNAL_RETROLX_PATH)/package/retrolx/emulators/libretro/libretro-easyrpg/PKGINFO \
