...
LIBRETRO_FUSE_PKG_INSTALL_DIR = /userdata/packages/$(BATOCERA_SYSTEM_ARCH)/lr-fuse
...
define LIBRETRO_FUSE_MAKEPKG
	...
	cd $(LIBRETRO_FUSE_PKG_DIR) && $(BR2_EXTERNAL_BATOCERA_PATH)/scripts/retrolx-makepkg \
	$(BR2_EXTERNAL_BATOCERA_PATH)/package/retrolx/emulators/libretro/libretro-fuse/PKGINFO \
