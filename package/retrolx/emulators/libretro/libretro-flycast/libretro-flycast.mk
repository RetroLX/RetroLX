...
# GLES 3
ifeq ($(BR2_PACKAGE_TARGET_RPI4)$(BR2_PACKAGE_TARGET_ODROIDXU4)$(BR2_PACKAGE_RETROLX_PANFROST_MESA3D),y)
LIBRETRO_FLYCAST_CONF_OPTS += -DUSE_GLES=ON
# GLES 2
else ifeq ($(BR2_PACKAGE_TARGET_RPI3)$(BR2_PACKAGE_RETROLX_LIMA_MESA3D),y)
