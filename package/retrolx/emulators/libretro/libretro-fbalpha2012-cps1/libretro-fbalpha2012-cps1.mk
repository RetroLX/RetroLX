...
#
################################################################################
# Version.: Commits on Jul 3, 2021
LIBRETRO_FBALPHA2012_CPS1_VERSION = be40afecc52654a3c1b33c44e7a176ecd9f94f2e
...
define LIBRETRO_FBALPHA2012_CPS1_MAKEPKG
	...
	# Copy package files
	$(INSTALL) -D $(@D)/fbalpha2012_libretro.so $(LIBRETRO_FBALPHA2012_CPS1_PKG_DIR)$(LIBRETRO_FBALPHA2012_CPS1_PKG_INSTALL_DIR)
