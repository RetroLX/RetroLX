...
LIBRETRO_FBALPHA_PKG_INSTALL_DIR = /userdata/packages/$(RETROLX_SYSTEM_ARCH)/lr-fbalpha
...
define LIBRETRO_FBALPHA_MAKEPKG
	...
	# Copy package files
	$(INSTALL) -D $(@D)/fbalpha_libretro.so $(LIBRETRO_FBALPHA_PKG_DIR)$(LIBRETRO_FBALPHA_PKG_INSTALL_DIR)
	...
	cd $(LIBRETRO_FBALPHA_PKG_DIR) && $(BR2_EXTERNAL_RETROLX_PATH)/scripts/retrolx-makepkg \
	$(BR2_EXTERNAL_RETROLX_PATH)/package/retrolx/emulators/libretro/libretro-fbalpha/PKGINFO \
