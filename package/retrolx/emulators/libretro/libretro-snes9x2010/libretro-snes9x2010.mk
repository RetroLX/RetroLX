...
LIBRETRO_SNES9X2010_VERSION = 1649a31d1ea0cc10a181ea4fec2698950c4ee780
...
LIBRETRO_SNES9X2010_PKG_INSTALL_DIR = /userdata/packages/$(BATOCERA_SYSTEM_ARCH)/lr-snes9x2010
...
define LIBRETRO_SNES9X2010_MAKEPKG
	...
	cd $(LIBRETRO_SNES9X2010_PKG_DIR) && $(BR2_EXTERNAL_BATOCERA_PATH)/scripts/retrolx-makepkg \
	$(BR2_EXTERNAL_BATOCERA_PATH)/package/retrolx/emulators/libretro/libretro-snes9x2010/PKGINFO \
