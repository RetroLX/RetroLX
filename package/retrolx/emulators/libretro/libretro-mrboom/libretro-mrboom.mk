...
LIBRETRO_MRBOOM_PKG_INSTALL_DIR = /userdata/packages/$(RETROLX_SYSTEM_ARCH)/lr-mrboom
...
define LIBRETRO_MRBOOM_MAKEPKG
	...
	cd $(LIBRETRO_MRBOOM_PKG_DIR) && $(BR2_EXTERNAL_RETROLX_PATH)/scripts/retrolx-makepkg \
	$(BR2_EXTERNAL_RETROLX_PATH)/package/retrolx/emulators/libretro/libretro-mrboom/PKGINFO \
