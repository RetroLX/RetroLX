...
define LIBRETRO_BLUEMSX_MAKEPKG
	# Create directories
	mkdir -p $(LIBRETRO_BLUEMSX_PKG_DIR)$(LIBRETRO_BLASTEM_PKG_INSTALL_DIR)/bios

	# Copy package files
	$(INSTALL) -D $(@D)/bluemsx_libretro.so \
	$(LIBRETRO_BLUEMSX_PKG_DIR)$(LIBRETRO_BLASTEM_PKG_INSTALL_DIR)
	cp -pr $(@D)/system/bluemsx/* \
	$(LIBRETRO_BLUEMSX_PKG_DIR)$(LIBRETRO_BLASTEM_PKG_INSTALL_DIR)/bios
