...
define SOLARUS_ENGINE_MAKEPKG
	...
	cp $(BR2_EXTERNAL_RETROLX_PATH)/package/retrolx/emulators/solarus-engine/__init__.py $(SOLARUS_ENGINE_PKG_DIR)$(SOLARUS_ENGINE_PKG_INSTALL_DIR)
	cp $(BR2_EXTERNAL_RETROLX_PATH)/package/retrolx/emulators/solarus-engine/generator.py $(SOLARUS_ENGINE_PKG_DIR)$(SOLARUS_ENGINE_PKG_INSTALL_DIR)
