...
FHEROES2_PKG_INSTALL_DIR = /userdata/packages/$(BATOCERA_SYSTEM_ARCH)/fheroes2
...
define FHEROES2_MAKEPKG
	...
	cd $(FHEROES2_PKG_DIR) && $(BR2_EXTERNAL_BATOCERA_PATH)/scripts/retrolx-makepkg \
	$(BR2_EXTERNAL_BATOCERA_PATH)/package/retrolx/ports/fheroes2/PKGINFO \
