...
define HLSDK_XASH3D_OPFOR_INSTALL_TARGET_CMDS
	$(INSTALL) -m 0755 -t $(XASH3D_PKG_DIR)$(XASH3D_PKG_INSTALL_DIR)/lib/xash3d/hlsdk/opfor/cl_dlls/ -D $(@D)/cl_dll/*.so
	$(INSTALL) -m 0755 -t $(XASH3D_PKG_DIR)$(XASH3D_PKG_INSTALL_DIR)/lib/xash3d/hlsdk/opfor/dlls/ -D $(@D)/dlls/*.so
endef
