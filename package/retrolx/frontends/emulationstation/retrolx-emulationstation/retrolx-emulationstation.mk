...
RETROLX_EMULATIONSTATION_CONF_OPTS += -DCMAKE_CXX_FLAGS=-D$(call UPPERCASE,$(RETROLX_SYSTEM_ARCH)) -DCMAKE_BUILD_TYPE=Debug #-DCMAKE_BUILD_TYPE=Release
...
define RETROLX_EMULATIONSTATION_MAKEPKG
	...
	$(INSTALL) -m 0755 -D $(@D)/libpugixml* $(RETROLX_EMULATIONSTATION_PKG_DIR)$(RETROLX_EMULATIONSTATION_PKG_INSTALL_DIR)
