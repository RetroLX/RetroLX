...
ifeq ($(BR2_PACKAGE_RETROLX_TARGET_S912),y)
...
#ifeq ($(BR2_PACKAGE_RETROLX_TARGET_ODROIDN2),y)
#UBOOT_AMLOGIC_FIPDIR="$(@D)/odroid-n2"
#UBOOT_AMLOGIC_ENCRYPT_BIN="aml_encrypt_g12b"
#endif
ifeq ($(BR2_PACKAGE_RETROLX_TARGET_S905GEN2),y)
UBOOT_AMLOGIC_FIPDIR="$(@D)/u200"
...
ifeq ($(BR2_PACKAGE_RETROLX_TARGET_S905GEN2)$(BR2_PACKAGE_RETROLX_TARGET_S922X)$(BR2_PACKAGE_RETROLX_TARGET_S905GEN3),y)
