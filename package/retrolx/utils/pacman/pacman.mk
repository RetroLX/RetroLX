...
define RETROLX_PACMAN_INSTALL_CONF
	...
	$(INSTALL) -D -m 0755 $(BR2_EXTERNAL_RETROLX_PATH)/package/retrolx/utils/pacman/retrolx-install-es-system.hook $(TARGET_DIR)/etc/pacman/hooks/retrolx/retrolx-install-es-system.hook
	$(INSTALL) -D -m 0755 $(BR2_EXTERNAL_RETROLX_PATH)/package/retrolx/utils/pacman/retrolx-uninstall-es-system.hook $(TARGET_DIR)/etc/pacman/hooks/retrolx/retrolx-uninstall-es-system.hook
