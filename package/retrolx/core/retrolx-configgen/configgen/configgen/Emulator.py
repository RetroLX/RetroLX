...
class Emulator():
    ...
    def __init__(self, name, rom):
        ...
        self.config = Emulator.get_system_config(self.name, "/usr/share/retrolx/configgen/configgen-defaults.yml", "/usr/share/retrolx/configgen/configgen-defaults-arch.yml")
