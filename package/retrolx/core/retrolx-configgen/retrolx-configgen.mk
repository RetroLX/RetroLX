...
define RETROLX_CONFIGGEN_EXTRACT_CMDS
	cp -R $(BR2_EXTERNAL_BATOCERA_PATH)/package/retrolx/core/retrolx-configgen/configgen/* $(@D)
endef
...
define RETROLX_CONFIGGEN_INSTALL_STAGING_CMDS
	...
	cp $(BR2_EXTERNAL_BATOCERA_PATH)/package/retrolx/core/retrolx-configgen/configs/configgen-defaults.yml $(STAGING_DIR)/usr/share/retrolx/configgen/configgen-defaults.yml
	cp $(BR2_EXTERNAL_BATOCERA_PATH)/package/retrolx/core/retrolx-configgen/configs/configgen-defaults-$(RETROLX_CONFIGGEN_SYSTEM).yml $(STAGING_DIR)/usr/share/retrolx/configgen/configgen-defaults-arch.yml
endef

define RETROLX_CONFIGGEN_CONFIGS
	mkdir -p $(TARGET_DIR)/usr/share/retrolx/configgen
	cp -pr $(BR2_EXTERNAL_BATOCERA_PATH)/package/retrolx/core/retrolx-configgen/datainit $(TARGET_DIR)/usr/lib/python3.9/site-packages/configgen/
	cp $(BR2_EXTERNAL_BATOCERA_PATH)/package/retrolx/core/retrolx-configgen/configs/configgen-defaults.yml $(TARGET_DIR)/usr/share/retrolx/configgen/configgen-defaults.yml
	cp $(BR2_EXTERNAL_BATOCERA_PATH)/package/retrolx/core/retrolx-configgen/configs/configgen-defaults-$(RETROLX_CONFIGGEN_SYSTEM).yml $(TARGET_DIR)/usr/share/retrolx/configgen/configgen-defaults-arch.yml
endef
