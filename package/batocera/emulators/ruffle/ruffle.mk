...
RUFFLE_VERSION = d7da19bffa892e51e6b6616becb3ab1d324f1673
...
define RUFFLE_INSTALL_TARGET_CMDS
	...
	# evmap config
	mkdir -p $(TARGET_DIR)/usr/share/evmapy
	cp $(BR2_EXTERNAL_RETROLX_PATH)/package/batocera/emulators/ruffle/flash.ruffle.keys $(TARGET_DIR)/usr/share/evmapy
endef
