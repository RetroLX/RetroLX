...
define BATOCERA_PACMAN_INSTALL_CONF
	...
	$(INSTALL) -D -m 0755 $(BR2_EXTERNAL_BATOCERA_PATH)/package/batocera/utils/pacman/retrolx-install-es-system.hook \
	$(TARGET_DIR)/etc/pacman/hooks/retrolx/retrolx-install-es-system.hook
	$(INSTALL) -D -m 0755 $(BR2_EXTERNAL_BATOCERA_PATH)/package/batocera/utils/pacman/retrolx-uninstall-es-system.hook \
