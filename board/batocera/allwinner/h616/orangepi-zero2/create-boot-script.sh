...
# ATF
"${BR2_EXTERNAL_RETROLX_PATH}/board/batocera/scripts/build-atf.sh" "${HOST_DIR}" "${BOARD_DIR}" "${BINARIES_DIR}" sun50i_h616
...
cp "${BINARIES_DIR}/sun50i-h616-orangepi-zero2.dtb" "${RETROLX_BINARIES_DIR}/boot/boot/"     || exit 1
