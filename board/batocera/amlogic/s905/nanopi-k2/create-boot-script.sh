...
# ATF
"${BR2_EXTERNAL_RETROLX_PATH}/board/batocera/scripts/build-atf.sh" "${HOST_DIR}" "${BOARD_DIR}" "${BINARIES_DIR}" gxbb
...
cp "${BINARIES_DIR}/meson-gxbb-nanopi-k2.dtb" "${RETROLX_BINARIES_DIR}/boot/boot/"     || exit 1
