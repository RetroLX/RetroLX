...
cp "${BUILD_DIR}/board/retrolx/allwinner/aw32/cha/packages.txt" "${RETROLX_BINARIES_DIR}/boot/packages.txt"
...
cp "${BINARIES_DIR}/kernel-aw32/sun8i-h3-libretech-all-h3-cc.dtb" "${RETROLX_BINARIES_DIR}/boot/boot/capcom-home-arcade.dtb"     || exit 1
