...
cp "${BINARIES_DIR}/kernel-rk356x/Image"                 "${RETROLX_BINARIES_DIR}/boot/boot/linux"                 || exit 1
...
cp "${BINARIES_DIR}/kernel-rk356x/rk3566-quartz64-a.dtb" "${RETROLX_BINARIES_DIR}/boot/boot/rk3566-quartz64-a.dtb" || exit 1
