...
cat "${BUILD_DIR}/board/retrolx/packages.txt" "${BUILD_DIR}/board/retrolx/rockchip/rk3328/packages.txt" > "${RETROLX_BINARIES_DIR}/boot/packages.txt"
...
cp "${BINARIES_DIR}/kernel-rk3328/rk3328-rock64.dtb"  "${RETROLX_BINARIES_DIR}/boot/boot/"     || exit 1
