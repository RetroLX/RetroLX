...
cat "${BUILD_DIR}/board/retrolx/packages.txt" "${BUILD_DIR}/board/retrolx/rockchip/rk3128/packages.txt" > "${RETROLX_BINARIES_DIR}/boot/packages.txt"
...
cp "${BINARIES_DIR}/kernel-rk3128/zImage"             	"${RETROLX_BINARIES_DIR}/boot/boot/linux"           || exit 1
...
cp "${BINARIES_DIR}/kernel-rk3128/modules"         	"${RETROLX_BINARIES_DIR}/boot/boot/modules"         || exit 1

cp "${BINARIES_DIR}/kernel-rk3128/rk3128-geniatech.dtb" "${RETROLX_BINARIES_DIR}/boot/boot/"     || exit 1
