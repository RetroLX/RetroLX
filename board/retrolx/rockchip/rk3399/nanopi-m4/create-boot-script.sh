...
cat "${BUILD_DIR}/board/retrolx/packages.txt" "${BUILD_DIR}/board/retrolx/rockchip/rk3399/packages.txt" > "${RETROLX_BINARIES_DIR}/boot/packages.txt"
...
cp "${BINARIES_DIR}/rk3399-nanopi-m4.dtb"  "${RETROLX_BINARIES_DIR}/boot/boot/"     || exit 1
