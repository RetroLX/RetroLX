...
cat "${BUILD_DIR}/board/retrolx/packages.txt" "${BUILD_DIR}/board/retrolx/raspberrypi/rpi4/packages.txt" > "${RETROLX_BINARIES_DIR}/boot/packages.txt"
...
cp -f  "${BINARIES_DIR}/bcm2711"*.dtb   "${RETROLX_BINARIES_DIR}/boot/" || exit 1
